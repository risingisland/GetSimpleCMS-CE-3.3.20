		...
		<?php
			if (file_exists($file)) {
				...
				foreach ($readed as $file) {
					...
					echo '
					<div style="display:block; position:relative; width:100%; border:solid 1px #ddd; margin-top:15px; background:#fafafa; padding:5px; box-sizing:border-box; padding-top:40px;">
...
<script>
	function addNewSnippet() {
		...
		<div style="display:block; position:relative; width:100%; border:solid 1px #ddd; margin-top:15px; background:#fafafa; padding:5px; box-sizing:border-box; padding-top:30px;">
			<button style="border-radius:5px; position:absolute; top:5px; right:10px; background:red; color:#fff; border:none;" onclick="event.preventDefault();closeThisSnippet(this)"> ✕ </button>
