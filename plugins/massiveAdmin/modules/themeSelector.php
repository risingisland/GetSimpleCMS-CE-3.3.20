...
echo '<div style="width:100%;background:var(--main-color);padding:10px;border-radius:5px;color:#fff;margin-top:20px;display:block;" class="done-info">Done! You choose '.$_POST['theme'].' Theme</div>';
