...
CKEDITOR.lang['uk'] = {
	...
	"button": {
		"selectedLabel": "%1 (Обрано)"
	},
	"colorbutton": {
		"auto": "Автоматично",
		"bgColorTitle": "Кольор фону",
		"colors": {
			"000": "Black",
			"800000": "Maroon",
			"8B4513": "Saddle Brown",
	...
	"find": {
		...
		"replaceSuccessMsg": "%1 співпадінь змінено.",
	...
	"font": {
		"fontSize": {
			...
			"panelTitle": "Розмір шрифта"
		},
		"label": "Шрифт",
		"panelTitle": "Назва шрифта",
		"voiceLabel": "Шрифт"
	},
	"format": {
		"label": "Форматування",
	...
	"iframe": {
		...
		"noUrl": "Будь-ласка введіть URL фрейму",
		"scrolling": "Увімкнути смуги прокрутки",
		"title": "Властивості IFrame",
		"toolbar": "IFrame"
	},
	"image": {
	...
	"link": {
		...
		"title": "Посилання",
		"toAnchor": "Посилання на якір в тексті",
		"toEmail": "Ел. пошта",
		"toUrl": "URL",
